...
# --- ESTILIZAÇÃO (CSS "BLUE OCEAN" + FIX BARRA BRANCA) ---
st.markdown("""
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;700&display=swap');
    html, body, [class*="css"] { font-family: 'Roboto', sans-serif; }
    
    /* ESCONDER A BARRA PADRÃO DO STREAMLIT (HAMBURGER MENU) */
...
def tela_login():
    ...
    with col2:
        ...
        st.markdown(f'<img src="{img_b64}" style="width: 220px; margin-bottom: 20px;">', unsafe_allow_html=True)
        st.markdown("<h2 style='color: #004080; margin-bottom: 5px;'>Portal Culligan</h2>", unsafe_allow_html=True)
        
        with st.form("frm_login"):
            u = st.text_input("Usuário", placeholder="Login")
            s = st.text_input("Senha", type="password", placeholder="Senha")
        ...
        # FERRAMENTA HASH (Aparece só na tela de login pra ajudar a configurar)
